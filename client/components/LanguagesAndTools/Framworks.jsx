  ...
  return (
    <div className='col-span-1 pt-2 w-full'>
        <div className='flex justify-start items-center pt-2 gap-x-2 dark:text-blue-500'>
            <RiTailwindCssFill   className='lg:text-2xl'/>
            <FaNodeJs   className='lg:text-2xl'/>
            <h3 className='lg:text-2xl'>Framworks</h3> 

        </div>
        <div className="flex flex-col justify-start items-start pt-4 lg:gap-y-2 ">
            <div className="flex justify-start items-start gap-x-5 border border-gray-500 w-full rounded-lg pl-2 py-1">
            <FaReact   className='lg:w-[100px] lg:h-[100px] dark:text-blue-500' />
            ...
            <div className="flex justify-start items-start gap-x-5 border border-gray-500 w-full rounded-lg pl-2 py-1">
            <FaNodeJs   className='lg:w-[100px] lg:h-[100px] dark:text-blue-500' />
                <div className='flex flex-col justify-start items-start lg:gap-y-1 pt-3'>
            ...
            <div className="flex justify-start items-start gap-x-5 border border-gray-500 w-full rounded-lg pl-2 py-1">
            <RiTailwindCssFill   className='lg:w-[100px] lg:h-[100px] dark:text-blue-500' />
                <div className='flex flex-col justify-start items-start lg:gap-y-1 pt-3'>
