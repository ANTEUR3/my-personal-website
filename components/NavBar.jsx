...
useEffect(()=>{console.log(theme)},[theme])
  return (
    ...
    <div className={'flex  justify-between items-center fixed z-10 w-full  px-4 md:px-5 lg:pl-10 lg:pr-[90px] border   font-navFont dark:bg-transparent dark:text-white  light:text-black font-semibold md:text-lg lg:text-lg '}>
